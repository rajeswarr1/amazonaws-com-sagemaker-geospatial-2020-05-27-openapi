# Amazon SageMaker geospatial capabilities MCP Server

This MCP (Model Content Protocol) server provides access to Amazon SageMaker geospatial capabilities API functionality through HTTP, HTTPS, and STDIO transport modes.
